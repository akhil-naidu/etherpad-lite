...
exports.checklist = {
  init: function (context) {
    ...
    var buttonHTML =
      '<li class="separator"></li><li class="acl-write" id="checklist"><a class="grouped-middle" data-l10n-id="pad.toolbar.checklist.title" title="Task list Checklist"><span class="buttonicon icon-check"></span></a></li>';
